...
from nuscenes.eval.agnostic_detection.data_classes import AgnosticDetectionConfig


def config_factory(configuration_name: str) -> AgnosticDetectionConfig:
    """
    ...
    with open(cfg_path, 'r') as f:
        data = json.load(f)
    cfg = AgnosticDetectionConfig.deserialize(data)
