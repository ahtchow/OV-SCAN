...
from nuscenes.eval.agnostic_detection.data_classes import DetectionBox
from nuscenes.eval.agnostic_detection.utils import category_to_detection_name
...
def filter_eval_boxes(nusc: NuScenes,
                      ...
                      filter_by_points: bool = True,
                      filter_bike_rack: bool = True,
